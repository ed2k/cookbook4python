 ...
 *
 * RCS: @(#) $Id: winMain.c,v 1.4 2003/11/28 07:01:19 lexspoon Exp $
 */
 ...
 * #define and uses Floater if it doesn't exist.
 */
    
#ifndef TK_LOCAL_APPINIT
#define TK_LOCAL_APPINIT Floater
#endif
    ...
    Tcl_Interp *interp;		/* Interpreter for application. */
{
    ...
    Tcl_SetVar(interp, "tcl_rcFileName", "~/floaterrc.tcl", TCL_GLOBAL_ONLY);
    return TCL_OK;

error:
    MessageBeep(MB_ICONEXCLAMATION);
    MessageBox(NULL, Tcl_GetStringResult(interp), "Error in Floater",
...
WishPanic TCL_VARARGS_DEF(CONST char *,arg1)
{
    ...
    MessageBeep(MB_ICONEXCLAMATION);
    MessageBox(NULL, buf, "Fatal Error in Floater",
	    MB_ICONSTOP | MB_OK | MB_TASKMODAL | MB_SETFOREGROUND);
#ifdef _MSC_VER
    DebugBreak();
#endif
