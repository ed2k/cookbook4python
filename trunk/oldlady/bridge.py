...
class Bid:
    ...
    def __cmp__ (self, other):
        # Ordering doesn't make any sense for pass/double/redouble, but
        # (in)equality tests are always meaningful.
        return self.level.__cmp__ (other.level) or self.denom.__cmp__ (other.denom)
...
class Deal:
    ...
    def bid (self, bid):
        ...
        if bid.is_pass ():
            ...
            assert self.contract is None or bid > self.contract
            self.contract = bid
            self.passes = 0
